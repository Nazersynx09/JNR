...
export default function Hero() {
  return (
    <section className="bg-zinc-900 text-white py-16 px-6 flex items-center justify-center min-h-screen ">
      <div className="max-w-4xl w-full flex flex-row items-center justify-between gap-5 scale [0.9] md:scale-120">
        ...
        <div className="text-center md:text-left max-w-xl">
          ...
          <p className="mt-3 text-sm md:text-base text-gray-300 md:text-xs">
          ...
          <div className="mt-6">
            <Link
              ...
              className="bg-transparent border border-white text-white px-4 py-2 rounded-full text-sm font-semibold hover:bg-white hover:text-black transition-colors duration-200"
            >
              Download Resume
            </Link>
          </div>
